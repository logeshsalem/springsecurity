...
//					.sessionFixation(sfc->sfc.none())  //prevent session fixation attact spring boot will default session fixation 
					.invalidSessionUrl("/invalidSession")
					.maximumSessions(1).maxSessionsPreventsLogin(true))  //expired url we can add in the future
...
//		http.exceptionHandling(ehc -> ehc.authenticationEntryPoint(new CustomBasicAuthenticationPoint()));  //global config
